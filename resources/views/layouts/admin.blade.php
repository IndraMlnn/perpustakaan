        ...
        <main class="p-6">
            ...
            <div class="space-y-6">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                    <!-- Total Books -->
                    <div class="card stat-card rounded-lg p-6">
                        <div class="flex items-center">
                    ...
                    <div class="card stat-card rounded-lg p-6">
                        ...
                        <div class="mt-4">
                            <span class="text-sm text-red-600 font-medium">+2 from yesterday</span>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="space-y-4">
                            <div class="flex items-center">
                                ...
                                <div class="ml-3 flex-1">
                                    <p class="text-sm text-gray-900">New book "Advanced Programming" added</p>
                            ...
                            <div class="flex items-center">
                                ...
                                <div class="ml-3 flex-1">
                                    <p class="text-sm text-gray-900">New user John Doe registered</p>
                            ...
                            <div class="flex items-center">
                                ...
                                <div class="ml-3 flex-1">
                                    <p class="text-sm text-gray-900">Book "Data Science" was borrowed</p>
